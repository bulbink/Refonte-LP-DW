 ...
 */
class pgm_DataProvider {

    /**
     * Global access point instance
     * @var pgm_DataProvider 
     */
    private static $instance;

    /**
     * Provide global access point
     * @return pgm_DataProvider
     */
    public static function instance() {
	if (self::$instance == null) {
	    self::$instance = new pgm_DataProvider();
	}
	...
	$id = pgm_Helper::arr_get($map_object, 'id');
	$create_new = (!is_numeric($id));
	$name = pgm_Helper::arr_get($map_object, 'name');
