 ...
 */
class pgm_Map_List_Table extends WP_List_Table {
	...
	return sprintf("<img src='%s' style='margin-left: 10px'/>", pgm_ResourceLoader::instance()->load_img('img/menu_active.png'));
    }
	...
	echo '<br /><center><a href="http://www.linkslive.info" target="_blank">Submit Your Website to 100+ Sites for FREE!</a></center>';
	return $columns;
    }
	...
	$direction = pgm_Helper::arr_get($_GET, 'order', 'asc');
	...
	$result = pgm_DataProvider::instance()->get_list(7, $this->get_pagenum(), $ordering);
