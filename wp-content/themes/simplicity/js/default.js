...
function setDropDownMenuPosition(){
	...
	menu_items.each( function(i) {
		...
		var menu_item_position = $j(menu_items[i]).offset().left;
			...
			var u = browser_width - menu_item_position + 30; // 30 is right padding between menu elements
			var m;
			
			if($j(menu_items[i]).find('li.sub').length > 0){
				m = browser_width - menu_item_position - sub_menu_width + 30; // 30 is right padding between menu elements
			}
